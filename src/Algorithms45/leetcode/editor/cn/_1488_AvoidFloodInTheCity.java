...
public class _1488_AvoidFloodInTheCity {

  public static void main(String[] args) {
    Solution solution = new _1488_AvoidFloodInTheCity().new Solution();
    int[] arr = new int[]{1, 2, 0, 0, 2, 1};
    solution.avoidFlood(arr);
    arr = new int[]{1, 2, 3, 4};
    solution.avoidFlood(arr);
    arr = new int[]{1, 2, 0, 1, 2};
    solution.avoidFlood(arr);
    arr = new int[]{69, 0, 0, 0, 69};
    solution.avoidFlood(arr);
    arr = new int[]{10, 20, 20};
    solution.avoidFlood(arr);
  }
    ...
    public int[] avoidFlood(int[] rains) {
      ...
      for (int i = 0; i < rains.length; i++) {
        ...
        if (rain == 0) {
          ...
          ans[i] = -1;
          if (occur.containsKey(rain)) {
            Integer pos = set.ceiling(occur.get(rain));
            if (pos == null) {
              return new int[]{};
            }
            else {
