...
public class _1387_SortIntegersByThePowerValue {
  ...
  public static void main(String[] args) {
    Solution solution = new _1387_SortIntegersByThePowerValue().new Solution();
  ...
  class Solution {
    ...
    public int getKth(int lo, int hi, int k) {
      PriorityQueue<Power> que = new PriorityQueue<>(1,
          (a, b) -> a.power == b.power ? b.num - a.num : b.power - a.power);

      for (int i = lo; i <= hi; i++) {
        que.offer(new Power(i));
