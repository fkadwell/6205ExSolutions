...
import static Algorithms45.Ch_5_1.Ex_5_1_07._KeyIndexCounting.getInput;
import static Algorithms45.Ch_5_1.Ex_5_1_07._KeyIndexCounting.sort;

import Algorithms45.edu.princeton.cs.algs4.Queue;
...
public class Ex_5_1_07 {
  ...
  public static void main(String[] args) {
    _ItemKeyIndex[] a = _KeyIndexCounting.getInput();
    _KeyIndexCounting.sort(a);
    StdOut.println("排序之后：");
