...
import static Algorithms45.Ch_1_2.Ex_1_2_17._Rational.addExtract;
import static Algorithms45.Ch_1_2.Ex_1_2_17._Rational.multExtract;
import static Algorithms45.Ch_1_2.Ex_1_2_17._Rational.subExtract;
...
public class Ex_1_2_17 {
  ...
  //@Test
  public void testAdd(){
    _Rational.addExtract(Long.MIN_VALUE, Long.MIN_VALUE);
  }

  //@Test
  public void testMult() {
    _Rational.multExtract(Long.MIN_VALUE, 1);
    _Rational.multExtract(Long.MIN_VALUE, Long.MIN_VALUE);
  }

  //@Test
  public void testSub() {
    long r = _Rational.subExtract(2, 1);
    assert r == 1L;
    r = _Rational.subExtract(Long.MAX_VALUE, -1);
  }
