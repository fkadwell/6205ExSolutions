 ...
 *  The <em>parent</em> operation determines in which connected component
 ...
 *  Afterwards, the <em>parent</em>, <em>count</em>, <em>connected</em>,
...
public class CC {
    ...
    private int[] id;           // parent[v] = parent of connected component containing v
    private int[] size;         // size[parent] = number of vertices in given component
    ...
    /**
     * Returns the component parent of the connected component containing vertex {@code v}.
     *
     * @param  v the vertex
     * @return the component parent of the connected component containing vertex {@code v}
